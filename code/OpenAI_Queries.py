...
try:
    ...
    with col1:
        st.image(os.path.join('images','tp-link.png'))
    ...
    if question != '':
        ...
        st.session_state['question'], st.session_state['response'], st.session_state['context'], sources, verbose_info = llm_helper.get_semantic_answer_lang_chain(question, [])
